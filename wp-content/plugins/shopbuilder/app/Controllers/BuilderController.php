...
class BuilderController {
	...
	public function add_elementor_widget_categories( $elements_manager ) {
		...
		$builder_type                           = str_replace( 'My Account - ', '', $builder_type );
			...
			if ( 'ShopBuilder - Shop' === $title || 'ShopBuilder - Archive' === $title ) {
				...
				$pro_widgets = [
					[
						...
						'title'       => esc_html__( 'Ajax Product Filters', 'testimonial-slider-showcase' ),
						'description' => esc_html__( 'Ajax Product Filters', 'testimonial-slider-showcase' ),
