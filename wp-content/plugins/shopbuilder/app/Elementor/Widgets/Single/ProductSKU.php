 ...
 */
class ProductSKU extends ElementorWidgetBase {
	/**
	 * Construct function
	 *
	...
	public function __construct( $data = [], $args = null ) {
		$this->rtsb_name = esc_html__( 'Product SKU', 'shopbuilder' );
		$this->rtsb_base = 'rtsb-product-sku';
	...
	public function widget_fields() {
		...
		unset( $fields['meta_value_hover_color'] );
		return $fields;
	}
	...
	protected function render() {
        ...
        $this->theme_support();
		$data        = [
			'template'    => 'elementor/single-product/sku',
