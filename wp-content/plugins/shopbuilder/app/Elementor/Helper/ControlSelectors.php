	...
	public static function products_loop_default_selector(): array {
		$defaults = [
			...
			'icon_align'                     => [
				...
				'flex-direction' => '{{WRAPPER}} .products .product :is(a.add_to_cart_button, a.product_type_simple, a.product_type_grouped ) :is(i, span)',
			],
	...
	private static function product_widget_selectors(): array {
		$selectors = [
			...
			'rtsb-product-add-to-cart'     => [
				...
				'cart_icon_size'                    => '{{WRAPPER}} .rtsb-product-add-to-cart .cart .button i',
				'quantity_height'                   => [
				...
				'icon_size'                         => '{{WRAPPER}} .rtsb-product-add-to-cart .rtsb-quantity-box-group .rtsb-quantity-btn',
			...
			'rtsb-product-image'     => [
				...
				'zoom_position_vertical'   => [
					'zoom-icon-top'    => '{{WRAPPER}} .rtsb-product-images .images .woocommerce-product-gallery__trigger',
			...
			'rtsb-product-onsale'    => [
				'flash_sale_typography'          => '{{WRAPPER}} .rtsb-product-onsale .onsale',
				'product_flash_sale_color'       => '{{WRAPPER}} .rtsb-product-onsale .onsale',
				'flash_sale_bg_color'            => '{{WRAPPER}} .rtsb-product-onsale .onsale',
				'flash_sale_badge_width'         => '{{WRAPPER}} .rtsb-product-onsale .onsale',
				'flash_sale_badge_height'        => '{{WRAPPER}} .rtsb-product-onsale .onsale',
				'flash_sale_badge_border_radius' => '{{WRAPPER}} .rtsb-product-onsale .onsale',
				'product_badges'                 => [
	...
	private static function cart_widget_selectors(): array {
		$selectors = [
			...
			'rtsb-product-carttable'   => [
				...
				'icon_size'                         => '{{WRAPPER}} .woocommerce-cart-form .rtsb-quantity-box-group .rtsb-quantity-btn',
				'quantity_icon_color'               => '{{WRAPPER}} .woocommerce-cart-form .quantity i',
				'quantity_icon_hover_color'         => '{{WRAPPER}} .woocommerce-cart-form .quantity .rtsb-quantity-btn:hover i',
		...
		return apply_filters(
			...
			[
				...
				'product_price'       => [
					...
					'color'              => '{{WRAPPER}} .rtsb-elementor-container .price-wrapper',
					'regular_color'      => '{{WRAPPER}} .rtsb-elementor-container .price-wrapper del',
				...
				'pagination'          => [
					'typography'          => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li span, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					'alignment'           => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap',
					'width'               => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li span, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					'height'              => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li span, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					'color'               => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					'bg_color'            => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					...
					'hover_color'         => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a:hover, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button:hover',
					'hover_bg_color'      => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a:hover, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button:hover',
					'border'              => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li span, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					'border_hover_color'  => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a:hover, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button:hover',
					'border_active_color' => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li span',
					'border_radius'       => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li a, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list li span, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					'spacing'             => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap',
					'padding'             => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap .rtsb-load-more button',
					'margin'              => '{{WRAPPER}} .rtsb-elementor-container .rtsb-pagination ul.pagination-list, {{WRAPPER}} .rtsb-elementor-container .rtsb-pagination-wrap',
				],
				'product_add_to_cart' => [
