...
class RT_Social_Icons extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Social Icons', 'quiklearn-core' );
	...
	public function rt_fields(){
		...
		$repeater->add_control(
			'link', [
				...
				'label_block' => true,
				'placeholder' => esc_html__( 'https://your-link.com', 'quiklearn-core' ),
			]
		);
		$repeater->add_control(
			'icon_color', [
		...
		$repeater->add_control(
			'title', array(
				...
				'default' => esc_html__( 'Social' , 'quiklearn-core' ),
				'label_block' => true,
            )
		);
		$fields = array(
			array(
				'mode'    => 'section_start',
				'id'      => 'sec_general',
				'label'   => esc_html__( 'Social Icons', 'quiklearn-core' ),
			),			
			array(
				'type'    => Controls_Manager::TEXT,
				'id'      => 'social_label',
				'label'   => esc_html__( 'Social Label', 'quiklearn-core' ),
				'default' => esc_html__( 'Share', 'quiklearn-core' ),
			),
			array(
