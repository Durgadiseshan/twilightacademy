...
$quiklearn_has_entry_meta  = ( $data['post_author'] == 'yes' || $data['post_date'] == 'yes' || $data['post_comment'] == 'yes' || $data['post_length'] == 'yes' && function_exists( 'quiklearn_reading_time' ) || $data['post_view'] == 'yes' && function_exists( 'quiklearn_views' ) ) ? true : false;
			...
			<div class="rt-grid-item <?php echo esc_attr( $col_class );?> <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
				<div class="rt-item">
					...
					<div class="entry-content">
						...
						<div class="entry-category"><i class="icon-quiklearn-tags"></i><?php echo the_category( ', ' );?></div>
						<?php } ?>
