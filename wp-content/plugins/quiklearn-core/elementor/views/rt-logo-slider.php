	...
	<div class="rt-swiper-slider" data-xld ="<?php echo esc_attr( $data['swiper_data'] );?>">
				...
				<div class="swiper-slide">
					<div class="logo-box <?php echo esc_attr( $data['logo_color_mode'] );?> <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">	
						<?php if ( !empty( $logo['url'] ) ): ?>
							<a href="<?php echo esc_url( $logo['url'] );?>" aria-label="Logo Link" target="_blank"><?php echo wp_get_attachment_image( $logo['image']['id'], 'full' )?></a>
						<?php else: ?>
		...
		<?php if ( $data['display_arrow'] == 'yes' ) { ?>
			<div class="swiper-navigation">
	            <div class="swiper-button-prev"><i class="icon-quiklearn-left-arrow"></i><?php echo esc_html__( 'Prev' , 'quiklearn' ) ?></div>
		    	<div class="swiper-button-next"><?php echo esc_html__( 'Next' , 'quiklearn' ) ?><i class="icon-quiklearn-right-arrow"></i></div>
	        </div>
		<?php } ?>
