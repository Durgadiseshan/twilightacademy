...
<div class="rt-testimonial-default testimonial-multi-layout-2 testimonial-<?php echo esc_attr( $data['layout'] );?>">
	<div class="row <?php echo esc_attr( $data['item_gutter'] );?>">
		<?php $m = $data['delay']; $n = $data['duration']; 
			foreach ( $data['testimonials'] as $testimonial ) { ?>
			<div class="rt-item <?php echo esc_attr( $col_class );?> <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $m );?>s" data-wow-duration="<?php echo esc_attr( $n );?>s">				
