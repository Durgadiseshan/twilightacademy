...
class QuiklearnTheme_About_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
            'quiklearn_about_author', // Base ID
            esc_html__( 'Quiklearn : About Author', 'quiklearn-core' ), // Name
            array( 'description' => esc_html__( 'About Author Widget', 'quiklearn-core' ) ) // Args
            );
	}
	...
	public function widget( $args, $instance ){
		...
		<div class="author-widget" style="background-image: url(<?php echo $bg_img; ?>)">
			...
			if( !empty( $instance['buttontext'] ) ){
				?><a class="about-btn button-style-2 btn-common" href="<?php echo esc_url( $instance['buttonurl'] ); ?>"><?php echo esc_html( $instance['buttontext'] ); ?><i class="icon-quiklearn-right-arrow"></i></a><?php
			}
			?>
	...
	public function form( $instance ){
		$defaults = array(
			'title'   		=> esc_html__( 'About Author' , 'quiklearn-core' ),
			'subtitle'		=> '',
			'text'			=> '',
			'bg_image'    	=> '',
			'buttontext'   => '',
		...
		$fields = array(
			...
			'bg_image'    => array(
				'label'   => esc_html__( 'background image', 'quiklearn-core' ),
				'type'    => 'image',
			),
			'subtitle' => array(
			...
			'text' => array(
				'label'   => esc_html__( 'Text', 'quiklearn-core' ),
				'type'    => 'text',
			),
			'buttontext'     => array(
