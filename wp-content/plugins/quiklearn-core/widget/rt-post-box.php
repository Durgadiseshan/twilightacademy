...
Class QuiklearnTheme_Post_Box extends WP_Widget {
	public function __construct() {
		$widget_ops = array(
			'classname' => 'rt-post-box',
			'description' => esc_html__( 'Post Display Widget' , 'quiklearn-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-post-box', esc_html__( 'Quiklearn : Posts display Box' , 'quiklearn-core' ), $widget_ops );		
	}
				...
				<div class="item-list">
					...
					<div class="post-content">
						...
						<div class="meta-wrap">
							...
							<?php } ?>
							<?php if ( $show_cat ) { ?>
							<div class="entry-cat"><i class="icon-quiklearn-coading"></i><?php
								$i = 1;
		...
		?>
			...
			<p>
				...
				<select name="<?php echo esc_attr( $this->get_field_name( 'post_display_order' )); ?>">
					...
					<option <?php if ( $post_display_order == 'rating' ) {  echo 'selected'; } ?> value="rating"><?php esc_html_e( 'Most Rating' , 'quiklearn-core' ); ?></option>
				</select>
			</p>
			<p>
