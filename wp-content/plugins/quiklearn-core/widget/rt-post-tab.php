...
Class QuiklearnTheme_Post_Tab extends WP_Widget {
	public function __construct() {
		$widget_ops = array(
			'classname' => 'rt-post-tab',
			'description' => esc_html__( 'Post Tab Display Widget' , 'quiklearn-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-post-tab', esc_html__( 'Quiklearn : Posts display Tab' , 'quiklearn-core' ), $widget_ops );		
	}
	public function widget( $args, $instance ) {
		...
		<div class="post-tab-layout">
			<ul class="btn-tab item-inline2 block-xs nav nav-tabs" role="tablist">
				<li class="nav-item">
					<a href="#recent-<?php esc_html_e( $tab_id ); ?>" data-bs-toggle="tab" aria-expanded="true" class="active"><?php esc_html_e('Recent', 'quiklearn-core'); ?></a>
				</li>
				<li class="nav-item">
					<a href="#popular-<?php esc_html_e( $tab_id ); ?>" data-bs-toggle="tab" aria-expanded="false"><?php esc_html_e( 'Popular', 'quiklearn-core'); ?></a>
				</li>
				<li class="nav-item">
					<a href="#common-<?php esc_html_e( $tab_id ); ?>" data-bs-toggle="tab" aria-expanded="false"><?php esc_html_e( 'Comment', 'quiklearn-core'); ?></a>
				</li>
			</ul>
						...
						<div class="media">
							...
							<div class="media-body">
								<div class="post-box-date">
									...
									<div class="meta-wrap">
										<?php if ( $show_date ) { ?>
											<div class="post-tab-date"><i class="icon-quiklearn-calendar"></i><?php echo get_the_time( get_option( 'date_format' ) ); ?></div>
										<?php } ?>
										<?php if ( $show_cat ) { ?>
										<div class="post-tab-cat"><i class="icon-quiklearn-coading"></i>
										<?php
											$i = 1;
