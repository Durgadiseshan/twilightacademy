...
$lecture_text  = $quiklearn_lecture == 1 ? esc_html__( ' Lesson', 'quiklearn' ) : esc_html__( ' Lessons', 'quiklearn' );
...
<div class="rt-course-box">
    ...
    <div class="rt-content-wrap">
		<ul class="rt-course-meta">
			...
			<li><i class="icon-quiklearn-admin"></i><span><?php echo esc_html( $quiklearn_enroll_count ); ?> <?php echo esc_html( $quiklearn_enroll_text ) ?></span></li>
        ...
        <div class="rt-content">
			...
			<?php } if ( QuiklearnTheme::$options['course_archive_instructor'] ) { ?>
                <div class="rt-author">- <a class="rtin-author" href="<?php echo esc_url( learn_press_user_profile_link( $quiklearn_author ) ); ?>"><?php echo wp_kses_post( $quiklearn_course->get_instructor_name() ); ?></a></div>
			<?php } ?>
