...
if( ! function_exists( 'quiklearn_breadcrumbs' )){

	function quiklearn_breadcrumbs(){
		...
		$home_text  = esc_html__( 'Home', 'quiklearn' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){
				...
				if ( get_post_type() == 'post' ){
					...
					$category = quiklearn_get_primary_category_id();
					$category = get_category( $category );
