...
trait IconTrait {
  ...
  {
    return [
        "icon-quiklearn-instagram"  => "instagram",
        "icon-quiklearn-left-arrow"  => "left-arrow",
        "icon-quiklearn-right-arrow"  => "right-arrow",
        "icon-quiklearn-location"  => "location",
        "icon-quiklearn-message"  => "message",
        "icon-quiklearn-maintain"  => "maintain",
        "icon-quiklearn-petroleum"  => "petroleum",
        "icon-quiklearn-quality-control"  => "quality-control",
        "icon-quiklearn-painter"  => "painter",
        "icon-quiklearn-pdf"  => "pdf",
        "icon-quiklearn-phone"  => "phone",
        "icon-quiklearn-pinterest"  => "pinterest",
        "icon-quiklearn-play"  => "play",
        "icon-quiklearn-plus"  => "plus",
        "icon-quiklearn-power"  => "power",
        "icon-quiklearn-quote-left"  => "quote-left",
        "icon-quiklearn-quote-right"  => "quote-right",
        "icon-quiklearn-rating"  => "rating",
        "icon-quiklearn-search"  => "search",
        "icon-quiklearn-select"  => "select",
        "icon-quiklearn-share"  => "share",
        "icon-quiklearn-shipping"  => "shipping",
        "icon-quiklearn-tags"  => "tags",
        "icon-quiklearn-testing"  => "testing",
        "icon-quiklearn-time"  => "time",
        "icon-quiklearn-twitter"  => "twitter",
        "icon-quiklearn-user"  => "user",
        "icon-quiklearn-up-arrow"  => "up-arrow",
        "icon-quiklearn-whatsapp"  => "whatsapp",
        "icon-quiklearn-worker"  => "worker",
        "icon-quiklearn-youtube"  => "youtube",
        "icon-quiklearn-angle-down"  => "angle-down",
        "icon-quiklearn-angle-left"  => "angle-left",
        "icon-quiklearn-angle-right"  => "angle-right",
        "icon-quiklearn-angle-up"  => "angle-up",
        "icon-quiklearn-architecture"  => "architecture",
        "icon-quiklearn-automotive"  => "automotive",
        "icon-quiklearn-calendar"  => "calendar",
        "icon-quiklearn-calendar-alt"  => "calendar-alt",
        "icon-quiklearn-cart"  => "cart",
        "icon-quiklearn-check"  => "check",
        "icon-quiklearn-comment"  => "comment",
        "icon-quiklearn-compare"  => "compare",
        "icon-quiklearn-construction"  => "construction",
        "icon-quiklearn-docs"  => "docs",
        "icon-quiklearn-facebook"  => "facebook",
        "icon-quiklearn-heart" => "heart",
    ];
  }
