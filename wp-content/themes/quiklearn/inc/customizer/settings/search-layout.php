 ...
 */
class QuiklearnTheme_Search_Layout_Settings extends QuiklearnTheme_Customizer {
    ...
    public function register_search_layout_controls( $wp_customize ) {
        ...
        $wp_customize->add_control( 'search_excerpt_length',
            array(
                'label' => __( 'Search Excerpt Length', 'quiklearn' ),
                'section' => 'search_layout_section',
                'type' => 'number',
            )
        );
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	new QuiklearnTheme_Search_Layout_Settings();
}
