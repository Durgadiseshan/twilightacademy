	...
	<?php
		...
		if ( $etn_left_tickets > 0 ) {
			...
			<h4 class="etn-widget-title etn-title etn-form-title">
				<?php
				$attendee_form_title = apply_filters( 'etn_event_purchase_form_title', esc_html__( "Registration Form", "quiklearn" ) );
			...
			?>
			<h6><?php echo esc_html__( 'No Tickets Available!!', "quiklearn" ); ?></h6>
			<?php
		}
