	...
	<div class="container">
		<div class="menu-full-wrap header-dark">
			<?php if ( class_exists( 'LearnPress' ) ) { ?>
				<?php get_template_part( 'template-parts/header/header', 'category-course' );?>
			<?php } ?>
			...
			<?php if ( QuiklearnTheme::$options['search_icon'] || QuiklearnTheme::$options['wishlist_icon'] || QuiklearnTheme::$options['cart_icon'] && class_exists( 'WC_Widget_Cart' ) || QuiklearnTheme::$options['vertical_menu_icon'] || QuiklearnTheme::$options['phone_icon'] ) { ?>
				<div class="header-icon-area">
